...
import { Truck, Package, Shield, Users, Star, Phone, Mail, MapPin, CheckCircle, MessageCircle } from "lucide-react"
  ...
  return (
    <div className="min-h-screen bg-background">
      <script
        ...
        dangerouslySetInnerHTML={{
          __html: JSON.stringify({
            ...
            description: "Empresa familiar con más de 35 años de experiencia en mudanzas nacionales e internacionales",
            url: "https://mudanzasvallasciani.com",
            telephone: "+542932635701",
            email: "transvallasciani@hotmail.com",
            address: {
              "@type": "PostalAddress",
              addressLocality: "Bahía Blanca",
              addressCountry: "AR",
            },
            areaServed: ["Bahía Blanca", "Buenos Aires", "Punta Alta", "Argentina"],
            foundingDate: "1989",
            serviceType: [
              "Mudanzas nacionales",
      ...
      <div className="fixed right-6 bottom-24 z-50">
        <button
          className="flex items-center gap-2 bg-green-600 hover:bg-green-700 text-white border-none rounded-full px-4 py-3 shadow-lg cursor-pointer font-semibold transition-all duration-300 hover:scale-105"
          onClick={() => {
        ...
        <div id="fabMenu" className="hidden mt-2" aria-hidden="true">
          <a
            className="block bg-white text-black no-underline border border-gray-200 rounded-xl px-3 py-2 mt-2 min-w-48 shadow-lg hover:bg-gray-50 transition-colors"
      ...
      <section className="relative min-h-screen flex items-center justify-center">
        ...
        <div className="relative z-10 container mx-auto px-4 text-center">
          ...
          <h2 className="font-geist text-5xl md:text-7xl font-bold text-white mb-4">Mudanzas Vallasciani</h2>
      ...
      <section className="py-20 bg-background">
        <div className="container mx-auto px-4">
          <div className="text-center mb-16">
            <h2 className="font-geist text-4xl md:text-5xl font-bold text-foreground mb-4">Nuestros Servicios</h2>
